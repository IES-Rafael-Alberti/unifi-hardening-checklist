...
| Contraseñas: Se han cambiado las claves por defecto del panel de administración del dispositivo y clave Wi-Fi. Haciendo uso de claves robustas entre 10 y 20 carácteres alfanúmericos y carácteres especiales. | Nivel: Alto | :black_square_button: |
